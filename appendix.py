...
# new_descriptions = []
# for row in jobs.description.values.astype(str):
#     words = row.split()
#     new_descriptions.append(' '.join([word for word in words if word not in STOPWORDS]))

# jobs.description = pd.Series(new_descriptions).values
